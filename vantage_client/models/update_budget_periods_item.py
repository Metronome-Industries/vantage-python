...
T = TypeVar("T", bound="UpdateBudgetPeriodsItem")


@_attrs_define
class UpdateBudgetPeriodsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_budget_periods_item = cls(
            start_at=start_at,
            amount=amount,
            end_at=end_at,
        )

        update_budget_periods_item.additional_properties = d
        return update_budget_periods_item
