...
T = TypeVar("T", bound="CreateBillingProfileBankingInformationAttributesSecureData")


@_attrs_define
class CreateBillingProfileBankingInformationAttributesSecureData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_billing_profile_banking_information_attributes_secure_data = cls(
        ...
        create_billing_profile_banking_information_attributes_secure_data.additional_properties = d
        return create_billing_profile_banking_information_attributes_secure_data
