...
T = TypeVar("T", bound="ChartSettings")
...
class ChartSettings:
    ...
    Attributes:
        ...
        x_axis_dimension (str | Unset): The dimension used to group or label data along the x-axis (e.g., by date,
            region, or service). NOTE: Only one value is allowed at this time. Defaults to ['date'].
    """

    y_axis_dimension: str | Unset = UNSET
    x_axis_dimension: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        x_axis_dimension = d.pop("x_axis_dimension", UNSET)
        ...
        chart_settings.additional_properties = d
