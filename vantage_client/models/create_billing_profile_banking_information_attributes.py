...
if TYPE_CHECKING:
    from ..models.create_billing_profile_banking_information_attributes_secure_data import (
        CreateBillingProfileBankingInformationAttributesSecureData,
    )


T = TypeVar("T", bound="CreateBillingProfileBankingInformationAttributes")


@_attrs_define
class CreateBillingProfileBankingInformationAttributes:
    ...
    Attributes:
        ...
        secure_data (CreateBillingProfileBankingInformationAttributesSecureData | Unset): Encrypted banking details
    """
    ...
    secure_data: CreateBillingProfileBankingInformationAttributesSecureData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        secure_data: CreateBillingProfileBankingInformationAttributesSecureData | Unset
        if isinstance(_secure_data, Unset):
            secure_data = UNSET
        else:
            secure_data = CreateBillingProfileBankingInformationAttributesSecureData.from_dict(_secure_data)

        create_billing_profile_banking_information_attributes = cls(
            token=token,
            bank_name=bank_name,
        ...
        create_billing_profile_banking_information_attributes.additional_properties = d
        return create_billing_profile_banking_information_attributes
