...
@_attrs_define
class UpdateBusinessMetricValuesCSVFilesBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_business_metric_values_csv_files_body.additional_properties = d
        return update_business_metric_values_csv_files_body
