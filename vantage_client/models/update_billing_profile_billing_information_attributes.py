...
T = TypeVar("T", bound="UpdateBillingProfileBillingInformationAttributes")


@_attrs_define
class UpdateBillingProfileBillingInformationAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_billing_profile_billing_information_attributes = cls(
            token=token,
        ...
        update_billing_profile_billing_information_attributes.additional_properties = d
        return update_billing_profile_billing_information_attributes
