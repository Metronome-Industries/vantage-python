...
class UpdateTeam:
    ...
    Attributes:
        ...
        role (UpdateTeamRole | Unset): The role to assign to the provided Users. Defaults to 'editor' which has editor
            permissions.
    """
    ...
    role: UpdateTeamRole | Unset = UNSET
