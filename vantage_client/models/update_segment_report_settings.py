...
T = TypeVar("T", bound="UpdateSegmentReportSettings")


@_attrs_define
class UpdateSegmentReportSettings:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_segment_report_settings = cls(
        ...
        update_segment_report_settings.additional_properties = d
        return update_segment_report_settings
