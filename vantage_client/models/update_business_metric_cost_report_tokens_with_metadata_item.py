...
class UpdateBusinessMetricCostReportTokensWithMetadataItem:
    ...
    Attributes:
        ...
        unit_scale (UpdateBusinessMetricCostReportTokensWithMetadataItemUnitScale | Unset): Determines the scale of the
    ...
    unit_scale: UpdateBusinessMetricCostReportTokensWithMetadataItemUnitScale | Unset = (
        UpdateBusinessMetricCostReportTokensWithMetadataItemUnitScale.PER_UNIT
    )
