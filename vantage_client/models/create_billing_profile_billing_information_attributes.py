...
T = TypeVar("T", bound="CreateBillingProfileBillingInformationAttributes")


@_attrs_define
class CreateBillingProfileBillingInformationAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_billing_profile_billing_information_attributes = cls(
            token=token,
        ...
        create_billing_profile_billing_information_attributes.additional_properties = d
        return create_billing_profile_billing_information_attributes
