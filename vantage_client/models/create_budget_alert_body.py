...
T = TypeVar("T", bound="CreateBudgetAlertBody")


@_attrs_define
class CreateBudgetAlertBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_budget_alert_body.additional_properties = d
        return create_budget_alert_body
