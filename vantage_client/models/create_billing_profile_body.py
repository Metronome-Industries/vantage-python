...
T = TypeVar("T", bound="CreateBillingProfileBody")


@_attrs_define
class CreateBillingProfileBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_billing_profile_body = cls(
            nickname=nickname,
        ...
        create_billing_profile_body.additional_properties = d
        return create_billing_profile_body
