...
if TYPE_CHECKING:
    from ..models.update_billing_profile_banking_information_attributes_secure_data import (
        UpdateBillingProfileBankingInformationAttributesSecureData,
    )


T = TypeVar("T", bound="UpdateBillingProfileBankingInformationAttributes")


@_attrs_define
class UpdateBillingProfileBankingInformationAttributes:
    ...
    Attributes:
        ...
        secure_data (UpdateBillingProfileBankingInformationAttributesSecureData | Unset): Encrypted banking details
    """
    ...
    secure_data: UpdateBillingProfileBankingInformationAttributesSecureData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        secure_data: UpdateBillingProfileBankingInformationAttributesSecureData | Unset
        if isinstance(_secure_data, Unset):
            secure_data = UNSET
        else:
            secure_data = UpdateBillingProfileBankingInformationAttributesSecureData.from_dict(_secure_data)

        update_billing_profile_banking_information_attributes = cls(
            token=token,
            bank_name=bank_name,
        ...
        update_billing_profile_banking_information_attributes.additional_properties = d
        return update_billing_profile_banking_information_attributes
