...
T = TypeVar("T", bound="CreateCostReportChartSettings")


@_attrs_define
class CreateCostReportChartSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_cost_report_chart_settings = cls(
            x_axis_dimension=x_axis_dimension,
            y_axis_dimension=y_axis_dimension,
        )

        create_cost_report_chart_settings.additional_properties = d
        return create_cost_report_chart_settings
