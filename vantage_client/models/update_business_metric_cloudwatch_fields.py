...
if TYPE_CHECKING:
    from ..models.update_business_metric_cloudwatch_fields_dimensions_item import (
        UpdateBusinessMetricCloudwatchFieldsDimensionsItem,
    )


T = TypeVar("T", bound="UpdateBusinessMetricCloudwatchFields")


@_attrs_define
class UpdateBusinessMetricCloudwatchFields:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_business_metric_cloudwatch_fields.additional_properties = d
        return update_business_metric_cloudwatch_fields
