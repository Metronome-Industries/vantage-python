...
from ..models.create_business_metric_cost_report_tokens_with_metadata_item_unit_scale import (
    CreateBusinessMetricCostReportTokensWithMetadataItemUnitScale,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateBusinessMetricCostReportTokensWithMetadataItem")


@_attrs_define
class CreateBusinessMetricCostReportTokensWithMetadataItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_unit_scale, Unset):
            ...
            unit_scale = CreateBusinessMetricCostReportTokensWithMetadataItemUnitScale(_unit_scale)

        label_filter = cast(list[str], d.pop("label_filter", UNSET))

        create_business_metric_cost_report_tokens_with_metadata_item = cls(
            cost_report_token=cost_report_token,
            unit_scale=unit_scale,
            label_filter=label_filter,
        )

        create_business_metric_cost_report_tokens_with_metadata_item.additional_properties = d
        return create_business_metric_cost_report_tokens_with_metadata_item
