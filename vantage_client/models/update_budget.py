...
class UpdateBudget:
    ...
    Attributes:
        name (str | Unset): The name of the Budget.
        ...
        periods (list[UpdateBudgetPeriodsItem] | Unset): The periods for the Budget. The start_at and end_at must be
    ...
    periods: list[UpdateBudgetPeriodsItem] | Unset = UNSET
