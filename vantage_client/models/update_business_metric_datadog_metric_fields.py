...
T = TypeVar("T", bound="UpdateBusinessMetricDatadogMetricFields")


@_attrs_define
class UpdateBusinessMetricDatadogMetricFields:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_business_metric_datadog_metric_fields = cls(
            integration_token=integration_token,
            query=query,
        )

        update_business_metric_datadog_metric_fields.additional_properties = d
        return update_business_metric_datadog_metric_fields
