...
T = TypeVar("T", bound="CreateBudgetAlertFilesBody")


@_attrs_define
class CreateBudgetAlertFilesBody:
    """
    Attributes:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        duration_in_days = (None, str(self.duration_in_days).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_budget_alert_files_body = cls(
            budget_tokens=budget_tokens,
            threshold=threshold,
            duration_in_days=duration_in_days,
        ...
        create_budget_alert_files_body.additional_properties = d
        return create_budget_alert_files_body
