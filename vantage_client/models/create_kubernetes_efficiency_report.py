...
class CreateKubernetesEfficiencyReport:
    ...
    Attributes:
        ...
        end_date (datetime.date | Unset): The end date of the KubernetesEfficiencyReport. ISO 8601 Formatted.
            Incompatible with 'date_interval' parameter.
        date_interval (CreateKubernetesEfficiencyReportDateInterval | Unset): The date interval of the
        ...
        aggregated_by (CreateKubernetesEfficiencyReportAggregatedBy | Unset): The column by which the costs are
            aggregated.
        date_bucket (CreateKubernetesEfficiencyReportDateBucket | Unset): The date bucket of the
    ...
    date_interval: CreateKubernetesEfficiencyReportDateInterval | Unset = UNSET
    aggregated_by: CreateKubernetesEfficiencyReportAggregatedBy | Unset = UNSET
    date_bucket: CreateKubernetesEfficiencyReportDateBucket | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        date_interval: CreateKubernetesEfficiencyReportDateInterval | Unset
        ...
        aggregated_by: CreateKubernetesEfficiencyReportAggregatedBy | Unset
        ...
        date_bucket: CreateKubernetesEfficiencyReportDateBucket | Unset
