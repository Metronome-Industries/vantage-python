...
if TYPE_CHECKING:
    from ..models.update_managed_account_business_information_attributes_metadata_custom_fields_item import (
        UpdateManagedAccountBusinessInformationAttributesMetadataCustomFieldsItem,
    )


T = TypeVar("T", bound="UpdateManagedAccountBusinessInformationAttributesMetadata")


@_attrs_define
class UpdateManagedAccountBusinessInformationAttributesMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_managed_account_business_information_attributes_metadata.additional_properties = d
        return update_managed_account_business_information_attributes_metadata
