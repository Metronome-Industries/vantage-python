...
from ..models.create_workspace_json_body_exchange_rate_date import CreateWorkspaceJsonBodyExchangeRateDate
...
class CreateWorkspaceJsonBody:
    ...
    Attributes:
        ...
        exchange_rate_date (Union[Unset, CreateWorkspaceJsonBodyExchangeRateDate]): The date to use for currency
            conversion. Default: CreateWorkspaceJsonBodyExchangeRateDate.DAILY_RATE.
    """

    name: str
    enable_currency_conversion: Union[Unset, bool] = True
    currency: Union[Unset, str] = UNSET
    exchange_rate_date: Union[Unset, CreateWorkspaceJsonBodyExchangeRateDate] = (
        CreateWorkspaceJsonBodyExchangeRateDate.DAILY_RATE
    )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_exchange_rate_date, Unset):
            ...
            exchange_rate_date = CreateWorkspaceJsonBodyExchangeRateDate(_exchange_rate_date)
