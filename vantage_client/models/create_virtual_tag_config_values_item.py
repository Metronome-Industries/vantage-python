...
if TYPE_CHECKING:
    from ..models.create_virtual_tag_config_values_item_cost_metric import CreateVirtualTagConfigValuesItemCostMetric


T = TypeVar("T", bound="CreateVirtualTagConfigValuesItem")


@_attrs_define
class CreateVirtualTagConfigValuesItem:
    """
    Attributes:
        ...
        cost_metric (Union[Unset, CreateVirtualTagConfigValuesItemCostMetric]):
    """

    filter_: str
    name: Union[Unset, str] = UNSET
    business_metric_token: Union[Unset, str] = UNSET
    cost_metric: Union[Unset, "CreateVirtualTagConfigValuesItemCostMetric"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_cost_metric, Unset):
            ...
            cost_metric = CreateVirtualTagConfigValuesItemCostMetric.from_dict(_cost_metric)

        create_virtual_tag_config_values_item = cls(
            filter_=filter_,
            name=name,
        ...
        create_virtual_tag_config_values_item.additional_properties = d
        return create_virtual_tag_config_values_item
