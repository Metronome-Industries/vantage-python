...
T = TypeVar("T", bound="BankingInformationSecureData")


@_attrs_define
class BankingInformationSecureData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        banking_information_secure_data = cls(
        ...
        banking_information_secure_data.additional_properties = d
        return banking_information_secure_data
