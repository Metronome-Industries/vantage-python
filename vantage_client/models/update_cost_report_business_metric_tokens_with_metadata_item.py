...
from ..models.update_cost_report_business_metric_tokens_with_metadata_item_unit_scale import (
    UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateCostReportBusinessMetricTokensWithMetadataItem")


@_attrs_define
class UpdateCostReportBusinessMetricTokensWithMetadataItem:
    """
    Attributes:
        business_metric_token (str): The token of the BusinessMetric to attach to the CostReport.
        unit_scale (Union[Unset, UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale]): Determines the scale
            of the BusinessMetric's values within the CostReport. Default:
            UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale.PER_UNIT.
        label_filter (Union[Unset, list[str]]): Include only values with these labels in the CostReport.
    """

    business_metric_token: str
    unit_scale: Union[Unset, UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale] = (
        UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale.PER_UNIT
    )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_unit_scale, Unset):
            ...
            unit_scale = UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale(_unit_scale)

        label_filter = cast(list[str], d.pop("label_filter", UNSET))

        update_cost_report_business_metric_tokens_with_metadata_item = cls(
            business_metric_token=business_metric_token,
            unit_scale=unit_scale,
            label_filter=label_filter,
        )

        update_cost_report_business_metric_tokens_with_metadata_item.additional_properties = d
        return update_cost_report_business_metric_tokens_with_metadata_item
