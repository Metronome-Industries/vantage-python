...
class UpdateCostReportBusinessMetricTokensWithMetadataItem:
    ...
    Attributes:
        ...
        unit_scale (UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale | Unset): Determines the scale of the
    ...
    unit_scale: UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale | Unset = (
        UpdateCostReportBusinessMetricTokensWithMetadataItemUnitScale.PER_UNIT
    )
