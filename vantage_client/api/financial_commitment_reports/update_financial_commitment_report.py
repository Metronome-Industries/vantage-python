...
from ...models.update_financial_commitment_report import UpdateFinancialCommitmentReport
...
def _get_kwargs(
    ...
    *,
    body: UpdateFinancialCommitmentReport,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        financial_commitment_report_token (str):
        body (UpdateFinancialCommitmentReport): Update a FinancialCommitmentReport.
