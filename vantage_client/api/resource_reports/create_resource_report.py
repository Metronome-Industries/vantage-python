...
from ...models.create_resource_report import CreateResourceReport
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ResourceReport.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        body (CreateResourceReport): Create a ResourceReport.
